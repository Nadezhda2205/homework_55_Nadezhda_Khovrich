...
from tasks.views import index_view, add_view, edit_view, delete_view, about_view, detail_view, confirm_delete
...
urlpatterns = [
    ...
    path('confirm-delete/<int:pk>', confirm_delete, name='confirm_delete'),
